...
适用于小天才手表的网易云音乐播放器 v20260331-fix1。
...
- 🔧 **修复自动播放** - 修复返回播放界面时音乐意外自动播放的问题
- 🔍 **关于页面优化** - 放大关于页面文字以适配手表屏幕
- 🔑 **登录入口精简** - 设置页面移除登录入口，仅保留更多菜单中的登录

## v20260331 更新说明（对比 v2.0）

- 🎵 **变速模式设置** - 新增"音调不变/音调改变"选项，分别对应时长缩放拉伸和样本播放速率
- 🔑 **登录入口调整** - 登录相关功能（Cookie/扫码/短信）移至"更多 > 登录"，方便快速访问
- ⚙️ **设置页面重构** - 设置页面改为平铺列表风格（开关选项/关于），与更多选项风格一致
...
| 版本 | 20260331-fix1 (versionCode 4) |
