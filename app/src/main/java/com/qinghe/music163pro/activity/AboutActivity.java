...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // v20260418 update summary
        content.addView(makeSpacer(px(8)));
        content.addView(makeText("v20260418 更新内容", 0xFFFFFFFF, px(18), true, Gravity.START));
        content.addView(makeSpacer(px(4)));
        content.addView(makeText(
                "• 增加歌曲高潮显示\n"
                + "• 增加智能截取铃声\n"
        ...
        // v20260416 update summary
        content.addView(makeSpacer(px(8)));
        content.addView(makeText("v20260416 更新内容", 0xFFFFFFFF, px(18), true, Gravity.START));
        content.addView(makeSpacer(px(4)));
        content.addView(makeText(
        ...
        // v20260412 update summary
        content.addView(makeSpacer(px(8)));
        content.addView(makeText("v20260412 更新内容", 0xFFFFFFFF, px(18), true, Gravity.START));
        content.addView(makeSpacer(px(4)));
        content.addView(makeText(
                "• 增加每日推荐功能\n"
                + "• 增加雷达歌单功能\n"
